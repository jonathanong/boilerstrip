...
/* eslint-disable */
export declare function convert(html: string, options?: ConvertOptions | undefined | null): Promise<ConvertResult>
...
export declare function learn(pages: Array<string>, options?: LearnOptions | undefined | null): Promise<Removals>
